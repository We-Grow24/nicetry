...
export default function SignUpForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!error && signUpData.user) {
      // Insert into public.users with 100 starting credits.
      // Uses upsert with ignoreDuplicates so double-clicks are safe.
    ...
    if (error) {
      ...
      // If enabled, the user will be redirected after clicking the email link.
      router.push("/");
      router.refresh();
    }
  }
        ...
        <div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {success && (
                <div className="mb-4 rounded-lg bg-success-50 px-4 py-3 text-sm text-success-600 dark:bg-success-500/10 dark:text-success-400">
